...
const About = () => {
  return (
    <Box  data-testid="about" className="about section" paddingTop="100" paddingLeft={{ md: "100" }} paddingRight={{ md: "100" }}  >
      ...
      >
        ...
        <Box
          ...
          height="fit-content"
        >
          <Text fontSize="lg" as="b" data-testid="user-detail-name">
            Hello, I'm Mayank Singh.
          </Text>
          <Text fontSize="lg" data-testid="user-detail-intro">
